...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RpaasAutoscalerSpec) DeepCopyInto(out *RpaasAutoscalerSpec) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RpaasAutoscalerSpec.
func (in *RpaasAutoscalerSpec) DeepCopy() *RpaasAutoscalerSpec {
	if in == nil {
		return nil
	}
	out := new(RpaasAutoscalerSpec)
	in.DeepCopyInto(out)
	return out
}
...
func (in *RpaasInstanceSpec) DeepCopyInto(out *RpaasInstanceSpec) {
	*out = *in
	...
	if in.AutoscalerSpec != nil {
		in, out := &in.AutoscalerSpec, &out.AutoscalerSpec
		*out = new(RpaasAutoscalerSpec)
		(*in).DeepCopyInto(*out)
	}
	return
